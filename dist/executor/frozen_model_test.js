...
describe('Model', function () {
    beforeEach(function () {
        ...
        model = new index_1.FrozenModel(MODEL_URL, WEIGHT_MANIFEST_URL);
        spyOn(window, 'fetch')
    ...
    describe('relative path', function () {
        beforeEach(function () {
            model = new index_1.FrozenModel(RELATIVE_MODEL_URL, RELATIVE_WEIGHT_MANIFEST_URL);
        });
        it('load', function () { return __awaiter(_this, void 0, void 0, function () {
            var loaded;
            return __generator(this, function (_a) {
    ...
    it('should loadFrozenModel', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, index_1.loadFrozenModel(MODEL_URL, WEIGHT_MANIFEST_URL)];
                case 1:
                    model = _a.sent();
    ...
    it('should loadFrozenModel with request options', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, index_1.loadFrozenModel(MODEL_URL, WEIGHT_MANIFEST_URL, { credentials: 'include' })];
                case 1:
                    model = _a.sent();
